...
export default class CreditsContainer extends Component {
	...
	render() {
		...
		<div className="home-container">
			...
			<div className="octocat"><a title="View the GitHub repository for this application" target="_blank" rel="noopener noreferrer" href="https://github.com/KingMew/Randyland-Directory"><img src={octocat} alt="View the GitHub repository for this application" /></a></div>
		</div>
		);
	}
}
